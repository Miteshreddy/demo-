 ...
 * 
 * UI/UX Projects:
 * 07 — StudentTribe (Student Community Platform)
 * 08 — NEXA (Business Intelligence & Operations)
 */

export const PROJECT_CATEGORIES = ['All', 'AI & ML', 'UI/UX'];
...
export const PROJECTS = [
  {
    ...
    technologies: ['Python', 'XGBoost', 'React', 'MongoDB'],
  ...
  },
  {
    ...
    technologies: ['Python', 'OpenCV', 'DeepFace', 'SQLite'],
  ...
  },
  {
    ...
    technologies: ['Python', 'YOLO', 'OpenCV', 'ByteTrack'],
  ...
  },
  {
    ...
    technologies: ['Python', 'PyTorch', 'Audio Processing', 'FastAPI'],
  ...
  },
  {
    ...
    year: '2026',
    featured: true,
    shortDescription: 'A modern student community platform designed to connect, collaborate, and grow together with elegant UI/UX and seamless user experience.',
    description: 'A comprehensive student community platform built with modern UI/UX principles, enabling students to connect, share resources, collaborate on projects, and build meaningful academic and professional networks.',
    problem: 'Students often struggle to find peers with shared academic interests, lack centralized platforms for resource sharing, and miss collaborative opportunities due to fragmented communication channels across campuses.',
    whatIBuilt: 'Designed and developed a full-featured student community web application with modern UI/UX design patterns, featuring intuitive navigation, responsive layouts, clean typography, and engagement-driven user flows.',
    technologies: ['React', 'UI/UX Design', 'CSS', 'Vercel', 'Responsive Design'],
    architecture: 'User Authentication → Community Dashboard → Resource Sharing Engine → Collaboration Workspace → Notification System',
    howItWorks: [
      { step: 'Onboarding', desc: 'Streamlined signup flow with interest-based profile creation and community matching.' },
      { step: 'Discovery', desc: 'Browse communities, find peers, and discover resources through intelligent search and filtering.' },
      { step: 'Collaboration', desc: 'Join study groups, share resources, and collaborate on academic projects in real-time.' },
      { step: 'Engagement', desc: 'Activity feeds, notifications, and gamification elements drive sustained platform engagement.' }
    ],
    keyFeatures: [
      'Modern, responsive student community interface with intuitive navigation',
      'Resource sharing and collaborative workspace for academic projects',
      'Interest-based community matching and peer discovery',
      'Clean, accessible design with mobile-first responsive layout'
    ],
    whatIWorkedOn: [
      'Designed the complete UI/UX system including typography, color palette, and component library.',
      'Built responsive frontend with React featuring smooth transitions and micro-interactions.',
      'Implemented community features including profiles, feeds, and resource sharing interfaces.',
      'Deployed and optimized the platform on Vercel for fast global access.'
    ],
    whatILearned: 'Advanced UI/UX design principles for community platforms, user engagement patterns, responsive design systems, and deploying production-ready web applications with optimal performance.',
    role: 'UI/UX Designer & Frontend Developer',
    image: '/projects/studenttribe/screenshot.png',
    screenshots: [
      { title: 'StudentTribe Community Platform', src: '/projects/studenttribe/screenshot.png', desc: 'Student community platform interface with modern design and collaborative features' }
    ],
    github: 'https://github.com/Miteshreddy/StudentTribe',
    liveDemo: 'https://student-tribe-beta.vercel.app/',
  },
  {
    id: 'nexa',
    num: '08',
    ...
    technologies: ['UI/UX Design', 'Figma', 'React', 'CSS', 'Data Visualization'],
    ...
    github: 'https://github.com/Miteshreddy',
    liveDemo: 'https://vercel.com/miteshreddys-projects/nexa/8ZJm7jA4CBdkBmi3eab1zcpKx3Fa',
